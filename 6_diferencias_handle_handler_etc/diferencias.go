...
func main() {
	...
	// Todo lo que esté adentro de esta carpeta, va a estar disponible para la aplicacion (se puede poner js, css, img, etc)
	...
	// DIFERENCIAS
	// funciones
	// http.Handle() // Manejador del Server Mux, implementa la interface Handler

	// http.HandleFunc() // manejador que recibe una funcion que implementa la firma (response write, request)

	// interface
	// http.Handler Interface

	// tipo
	// http.HandlerFunc Type, function
}
